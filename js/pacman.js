...
// const PacOpen = document.getElementById("scissorsOpen");
// const PacClosed = document.getElementById("scissorsClosed");
...
function drawPacman() {
	...
	const OpenLeft = new Image();
	const ClosedLeft = new Image();
	const OpenRight = new Image();
	const ClosedRight = new Image();
	const OpenUp = new Image();
	const ClosedUp = new Image();
	const OpenDown = new Image();
	const ClosedDown = new Image();
	// leftOpen.onload = () => {
	// 			// ctx.drawImage(img, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
	// };
	OpenLeft.src = "img/jas/scissorsOpenLeft.png";
	ClosedLeft.src = "img/jas/scissorsClosedLeft.png";
	OpenRight.src = "img/jas/scissorsOpenRight.png";
	ClosedRight.src = "img/jas/scissorsClosedRight.png";
	OpenUp.src = "img/jas/scissorsOpenUp.png";
	ClosedUp.src = "img/jas/scissorsClosedUp.png";
	OpenDown.src = "img/jas/scissorsOpenDown.png";
	ClosedDown.src = "img/jas/scissorsClosedDown.png";

	// ctx.drawImage(img, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);


	if (PACMAN_DIRECTION === 1) { // right
		if(PACMAN_MOUNTH_STATE){
			ctx.drawImage(OpenRight, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
		else{
			ctx.drawImage(ClosedRight, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
	} else if (PACMAN_DIRECTION === 2) { // down
		if(PACMAN_MOUNTH_STATE){
			ctx.drawImage(OpenDown, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
		else{
			ctx.drawImage(ClosedDown, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
	} else if (PACMAN_DIRECTION === 3) { // left
		if(PACMAN_MOUNTH_STATE){
			ctx.drawImage(OpenLeft, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
		else{
			ctx.drawImage(ClosedLeft, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
	} else if (PACMAN_DIRECTION === 4) { // up
		if(PACMAN_MOUNTH_STATE){
			ctx.drawImage(OpenUp, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
		else{
			ctx.drawImage(ClosedUp, PACMAN_POSITION_X-15, PACMAN_POSITION_Y-15, 30, 30);
		}
	}
